...
import { toggleTheme } from '../../store/AppState';
...
const Navbar = () => {
  ...
  return (
    <div class="navbar bg-base-100" data-theme={AppState.theme}>
        <div class="flex-none">
        ...
        <div class="flex justify-center items-center gap-2 lg:gap-4">
            ...
            <label class="swap swap-rotate">
                <input ref={toggleThemeRef} onChange={() => {
            ...
            </div>
            {
                AuthState.user ? (
                    ...
                    <>
                        <Link class="btn" to="/register">Sign In</Link>
