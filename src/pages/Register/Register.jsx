  ...
  return (
    ...
    <div className='px-16 py-10 rounded-lg border border-slate-500 bg-base-200 flex flex-col gap-4 w-1/3'>
      ...
      <form className='flex flex-col'>
        ...
        <input className='px-4 py-2 border border-slate-400 rounded-md mb-4' name="fullname" onChange={handleChange} value={formData.loginForm.email} />
        <label htmlFor="email" className='mt-4 mb-1'>Email:</label>
        <input className='px-4 py-2 border border-slate-400 rounded-md mb-4' name="email" onChange={handleChange} value={formData.loginForm.email} />
